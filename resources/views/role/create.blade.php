            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex flex-col">
                        <h1 class="text-center text-3xl uppercase font-bold text-gray-700"> New Rol </h1>
                    ...
                    <form action="{{ route('roles.store')  }}" method="POST" class="py-5">
                        @csrf
                        <div class="pb-3">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                @foreach ($permissions as $permission)
                                    <div class="inline-block">
                                        <input id="tag-{{$permission->id}}" type="checkbox" name="permissions[]" value="{{$permission->id}}" class="p-2 rounded shadow">
