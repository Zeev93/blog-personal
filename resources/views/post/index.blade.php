                            ...
                            <tbody>
                                @foreach ($posts as $post)
                                    <tr class="hover:bg-gray-300">
                                        ...
                                        <td>
                                            <a href="{{route('posts.show', ['post' => $post->id])}}" class="block bg-green-600 rounded py-1 px-4 m-2 text-white font-bold uppercase hover:bg-green-300 hover:text-green-600 text-center"><i class="fas fa-eye"></i></a>
                                        </td>
                                        <td>
                                            @can('posts.edit')
                                                <a href="{{route('posts.edit', ['post' => $post->id])}}" class="block bg-orange-600 rounded py-1 px-4 m-2 text-white font-bold uppercase hover:bg-orange-300 hover:text-orange-600 text-center"><i class="fas fa-pencil-alt"></i></a>
                                            @endcan
                                        </td>
                                        <td>
